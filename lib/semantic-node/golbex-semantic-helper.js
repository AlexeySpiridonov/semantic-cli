// golbex_semantic_helper.js
//
//      helper functions for golbex-semantic
let golbex_semantic_helper = {
  ...
  printUsage: function () {
    console.log('usage: golbex-semantic [option option=parameter ...] [destination]');
    console.log('');
...
for (let h in golbex_semantic_helper) {
  if (golbex_semantic_helper.hasOwnProperty(h)) {
    exports[h] = golbex_semantic_helper[h];
  }
}
